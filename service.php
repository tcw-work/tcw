            ...
            <div class="f-wrap">
                <div class="f-wrap-inner">
                    ...
                    <div id="p-service">
                        ...
                        <div class="p-s_about">
                            <p>LPEサービスページをご観覧いただき、誠にありがとうございます。こちらではWeb制作の依頼に関する詳細や大まかな金額、業務内容などを掲載しております。</p>
                        ...
                        <div class="p-s_request p-s_block" id="p-s_b_01">
                            ...
                            <div class="p-s_r_box">
                                <div class="p-box_left">
                                    <p><span>様々なご依頼を受付中です。</span>お客様のプランに合わせてご依頼していただく事が可能ですので、右記以外にもご要望等ごさいましたら、いつでもお申し付け下さい。</p>
                                </div>
                                    ...
                                    <ul>
                                        <li>
                                            <dl>
                                                ...
                                                <dd>静的サイトのコーディングからWordpressへの組込み（動的）などの制作が可能です。</dd>
                                                </a>
                                            </dl>
                                        </li>
                                        <li>
                            ...
                            <div class="p-s_detail">
                                <div class="p-s_d_block" id="p-s_d_b01">
                                    ...
                                    <dl>
                                        ...
                                        <dd>
                                            <p>フロントエンドエンジニアとしての実務経験を基に、ご要望に合わせたコーディングを行えます。UIを意識し、ユーザーへ直感的に情報を伝えるサイトや、企業様によっては導入されている「構造化マークアップ」などもご対応可能です。</p>
                                            <p>また、Wordpressへの組込みやホームページほレスポンシブ化（スマホ対応）、可変に対応したリキッドでの作業も承っております。</p>
                                        </dd>
                                    </dl>
                                </div>
                                ...
                                <div class="p-s_d_block" id="p-s_d_b03">
                                    ...
                                    <dl>
                                        ...
                                        <dd>
                                            <p>保守運用につきましては、サイトの規模や更新頻度、内容によって料金が異なりますので、お客様とヒアリングをさせていただく形にさせていただいております。</p>
                        ...
                        <div class="p-s_others p-s_block" id="p-s_b_03">
                            ...
                            <div id="p-port_works" class="p-port_block">
                                <p class="p-others_des">このサイトでは過去の作成した制作物を掲載しております。Web制作のご依頼をご検討中の方は、下記のサイトから技術、デザイン等をイメージしていただけますと幸いです。</p>
                                <div class="p-others_inner">
                                    ...
                                    <div class="p-others_01">
                                        <p><img src="image/other-work02.jpg" alt=""><span>Forkio</span></p>
                                    </div>
                                </div>
                                <div class="c-btn">
