        ...
        <nav class="drawer-nav" role="navigation">
            ...
            <div class="drawer-in">
                ...
                <ul class="drawer-menu">
                    ...
                    <li><a class="drawer-menu-item" href="/works/detail05.php"><span>TCW 技術ブログ</span></a></li>
                    ...
                    <li><a class="drawer-menu-item" href="/works/detail04.php"><span>旧TCD</span></a></li>
                    <!-- <li><a class="drawer-menu-item" href="/works.php#p-port_works-others"><span>その他テストサイト</span></a>
                    </li> -->
                </ul>
                <ul class="drawer-menu">
