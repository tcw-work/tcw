...
<!--        <meta name="viewport" content="width=device-width, initial-scale=1">-->
        ...
        <title>TCW トミザワ・クリエイティブ ワークス ポートフォリオページ</title>
                    ...
                    <div id="p-port_card">
                      <h2 class="c-head_2">Works</h2>
                       <div class="p-port_add">
                        ...
                        <div id="p-port_works01" class="p-port_block">
...
<!--
                                <a href="/LPE/自主制作/コーディング/works/detail01.php">
                                    <div class="p-port_img">
                                        <div class="p-port_img_in"><img src="image/t-cont01.jpg" alt=""></div>
                                        <div class="shadow-box"><span>Check</span></div>
                                    </div>
                                </a>
-->
                           ...
                           <div id="p-port_works03" class="p-port_block">
                            <h3 class="c-head_3">TCW トミザワクリエイティブワークス</h3>
                            <div class="p-port_inner">
                                <div class="p-port_img">
                                    <div class="p-port_img_in">
                           ...
                           <div id="p-port_works-others" class="p-port_block">
                               ...
                               <div class="p-others_inner">
                                   ...
                                   <div class="p-others_01">
                                       <a href="/LPE/自主制作/コーディング/works/test-site/02/" target="_blank">
                                           <p><img src="image/other-work02.jpg" alt="Forki"><span>Forkio</span></p>
                                       </a>
                                   </div>
                                   <div class="p-others_01">
                                       <a href="/LPE/自主制作/コーディング/works/test-site/03/" target="_blank">
                                           <p><img src="image/other-work03.jpg" alt="ZONYA"><span>ZONYA</span></p>
                                       </a>
                                   </div>
                                   <div class="p-others_01">
                                       <a href="/LPE/自主制作/コーディング/works/test-site/04/" target="_blank">
                                           <p><img src="image/other-work04.jpg" alt="AOD New York"><span>AOD</span></p>
                                       </a>
                                   </div>
                                   <div class="p-others_01">
                                       <a href="/LPE/自主制作/コーディング/works/detail-banner.php">
                                           <p><img src="image/other-work-banner.jpg" alt="banner"><span>banner</span></p>
                                       </a>
                                   </div>
                                   <div class="p-others_01">
                                       <a href="javascript:void(0)">
                                           <p><img src="image/other-work00.jpg" alt=""></p>
                                       </a>
                                   </div>
                               </div>
                           </div>
