            ...
            <div class="f-wrap-inner">
                ...
                <div id="p-service">
                    ...
                    <div class="p-s_request p-s_block" id="p-s_b_01">
                        <h2 class="c-head_2 c-head_2-3">ご依頼内容について</h2>
                        <div class="p-s_r_box">
                            <div class="p-box_left">
                                <p><span>様々なご依頼を受付中です。</span>お客様のプランに合わせて、部分的にご依頼していただく事も可能ですので、右記以外にもご要望等ごさいましたら、いつでもお申し付け下さい。
                                </p>
                            </div>
                        ...
                        <div class="p-s_detail">
                            <div class="p-s_d_block" id="p-s_d_b01">
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        <p>フロントエンドエンジニアとしての実務経験を基に、ご要望に合わせたコーディングを行います。UIを意識し、ユーザーへ直感的に情報を伝えるサイト、スライドやアニメーションなどの動きのあるサイト制作も可能です。
                                        </p>
                    ...
                    <div class="p-s_price p-s_block" id="p-s_b_02">
                        <h2 class="c-head_2 c-head_2-3">料金について</h2>
                        ...
                        <div class="p-s_p_block">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <th class="th_02">
                                        <p>※現在LPとバナーのデザインは承っておりませんので、ご了承ください。</p>
                                    </th>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="p-s_others p-s_block" id="p-s_b_03">
                        <h2 class="c-head_2 c-head_2-3">制作物について</h2>
