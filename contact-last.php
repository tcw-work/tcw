...
if(isset ($_POST['c_name']) or isset ($_POST['c_company']) or isset ($_POST['c_content'])) {
    //$action = $_POST['action'];
    $mail = "以下の内容が送信されました。\n\n";
    $mail = "【お名前】\n";
    $mail = $c_name."\n\n";
...
<!--        <meta name="viewport" content="width=device-width, initial-scale=1">-->
        ...
        <title>TCW トミザワ・クリエイティブ ワークス お問い合わせ完了ページ</title>
...
-->
                        <div class="p-c_address">
                            <p>※もし送信できない場合は、下記のアドレスに直接お問い合わせください。
                                <span><a href="mailto:m.tomizawa@821gmail.com">test-test-test-test@gmail.com</a></span>
                            </p>
                        </div>
                    </div>
