...
<html lang="jp">
    <head>
        ...
        <title>TCW ポートフォリオ「バナー」解説ページ</title>
        <meta name="description" content="TCWは、webサイト、ホームページの制作を随時承っております。個人で事業を営むクライアント様、一部制作をご依頼したい制作会社様からの業務等もご対応致します。フリーランスとして柔軟なご対応が可能ですので、お気軽にご連絡ください。">
        ...
        <meta property="og:description" content="TCWは、webサイト、ホームページの制作を随時承っております。個人で事業を営むクライアント様、一部制作をご依頼したい制作会社様からの業務等もご対応致します。フリーランスとして柔軟なご対応が可能ですので、お気軽にご連絡ください。">
            ...
            <div class="f-wrap">
                <div class="f-wrap-inner">
                  ...
                  <div id="p-port_detail">
                      <h2 class="c-head_2">バナー制作物（例）</h2>
<!--
                      <div class="p-detail_pic">
                          <img src="../image/detail-mv04.jpg" alt="">
                      </div>
-->
                      <div class="p-detail_banner">
                          <div class="p-detail_b_in">
                              <p class="banner-size">インライン レクタングル 300×250</p>
                              <img src="../image/banner01.png" alt="">
                          </div>
                          <div class="p-detail_b_in">
                              <p class="banner-size">ビッグバナー 320×100</p>
