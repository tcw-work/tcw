...
<html lang="jp">
    <head>
        ...
        <title>TCW トミザワ・クリエイティブ ワークス  ポートフォリオ「テンツーケア」解説ページ</title>
                  ...
                  <div id="p-port_detail">
                      ...
                      <div class="p-content_block">
                          ...
                          <div class="p-detail-des">
                              ...
                              <p>医療系のホームページと言うこともあり、「<b class="bold">自然と清潔感</b>」をコンセプトとしたデザインを視覚的に見せ、やすらぎや安心感を与える印象に仕上げました。</p>
                      ...
                      <div class="p-content_block">
                          ...
                          <div class="p-detail-des">
                              ...
                              <p>「<b class="bold">基本に忠実なサイト制作</b>」を意識しながら、常に他の民間救急関連のホームページよりも一番素晴らしいサイトを作る気持ちで制作いたしました。</p>
                          </div>
                      </div>
                      <div class="p-content_block">
                      ...
                      <div class="p-content_infor">
                          <ul>
                              ...
                              <li>
                                  <dl>
                                      <dt>URL</dt>
                                      <dd class="p-_post_url"><a href="https://tentucare.com/" target="_blank">https://tentucare.com/</a></dd>
                                  </dl>
                              </li>
                          </ul>
                      </div>
