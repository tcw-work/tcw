...
<head>
    ...
    <title>TCW ポートフォリオ「テンツーケア」解説ページ</title>
        ...
        <div class="f-wrap">
            <div class="f-wrap-inner">
                ...
                <div id="p-port_detail">
                    <h2 class="c-head_2">テンツーケア</h2>
                    <div class="p-detail_pic">
                        <img src="../image/detail-mv02.jpg" alt="テンツーケア MV">
                    </div>
                    <div class="p-content_block">
                        <h3 class="c-head_3">Design</h3>
                        <div class="p-detail-des">
                            <p>民間救急搬送（介護タクシー）事業を行うテンツーケア様のサイトを制作させていただきました。</p>
                            <p>医療系のホームページと言うこともあり、「<b
                                    class="bold">自然と清潔感</b>」をコンセプトとしたデザインを視覚的に見せ、やすらぎや安心感を与える印象に仕上げました。</p>
                            <p>例えば、森林を意識した緑の蛍光色と、それを際立出せる為に樹木を連想させる茶色をアクセントカラーとして使用しています。</p>
                            <p>これにより、ユーザーがサイトの印象をより直感的に受け止め、好印象を与える役割を担っています。</p>
                        </div>
                    </div>
                    <div class="p-content_block">
                        <h3 class="c-head_3">Marketing・Persona</h3>
                        <div class="p-detail-des">
                            <p>対象となるペルソナは、主に中高年と高齢者となっております。</p>
                            <p>その為、高齢者の利用を想定した見やすいフォントや導線等、自然なUIを意識して制作しました。</p>
                        </div>
                    </div>
                    <div class="p-content_block">
                        <h3 class="c-head_3">Coding</h3>
                        <div class="p-detail-des">
                            <p>技術面では、SCSSとBootstrapでのコーディング、JavascriptやCSSアニメーションの使用など、これまで培ってきた技術を活かしたサイトになっています。</p>
                            <p>また、リキッド（可変）での設計となっており、どの端末にも対応した仕様となっています。</p>
                            <p>「<b class="bold">基本に忠実なサイト制作</b>」を意識しながら、常に他の民間救急関連のホームページよりも一番素晴らしいサイトを作る気持ちで制作いたしました。
                            </p>
                        </div>
                    </div>
                    <div class="p-content_block">
                            ...
                            <ul>
                                <li>
                                    <div class="p-point_box">
                                        <div class="p-box_pic">
                                            <p>Technique</p>
                                            <img src="../image/detail-point01.jpg" alt="画像：ScssとBootstrapの組み合わせたコーディング">
                                        </div>
                                        <p class="p-box_des">ScssとBootstrapの組み合わせにより、効率的なコーディングを実現</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="p-point_box">
                                        <div class="p-box_pic">
                                            <p>Design</p>
                                            <img src="../image/detail-point02-02.jpg" alt="画像：「自然」を意識した清潔感のあるサイトデザイン">
                                        </div>
                                        <p class="p-box_des">緑と茶色の組み合わせにより、「自然」を意識した清潔感のあるサイトデザイン</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="p-point_box">
                                        <div class="p-box_pic">
                                            <p>UI</p>
                                            <img src="../image/detail-point02-03.jpg" alt="画像：ご年配の方にも見やすいデザイン">
                                        </div>
                                        <p class="p-box_des">スマホでもご利用者の年齢を想定したフォントや導線を意識した設計</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="p-point_box">
                                        ...
                                        <p class="p-box_des">基本的なSEO対策はもちろん、サーバー関連やドメイン設定等も担当。現在も保守運用を継続中</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="p-content_infor">
                        <ul>
                            <li>
                                <dl>
                                    <dt>Release Date</dt>
                                    <dd class="p-_post_date">2020.03.01</dd>
                                </dl>
                            </li>
                            <li>
                                <dl>
                                    <dt>URL</dt>
                                    <dd class="p-_post_url"><a href="https://corporate.t-creative-works.com/tentucare/"
                                            target="_blank">https://corporate.t-creative-works.com/tentucare/</a></dd>
                                </dl>
                            </li>
                        </ul>
                    </div>
