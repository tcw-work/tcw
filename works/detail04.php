                ...
                <div id="p-port_detail">
                    ...
                    <div class="p-content_block">
                        ...
                        <div class="p-detail-des">
							...
							<p>最大の特徴として、Javascriptによる不規則に動くモーショングラフィックス（メインビジュアル）をparticles.jsというライブラリを用いて作成し、ユーザーの視認性を上げるUIなどを意識した作りとなっています。
                            </p>
                            ...
                            <ul>
                                <li>
                                    <div class="p-point_box">
                                        <div class="p-box_pic">
                                            <p>Technique</p>
                                            <img src="../image/detail-point04-01.jpg" alt="">
                                        </div>
                                        <p class="p-box_des">FLOCSS設計による運用に適したコーディング</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="p-point_box">
                                        ...
                                        <p class="p-box_des">「モダン」×「テクノロジー」を意識したデザインコンセプト</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="p-point_box">
                    ...
                    <div class="p-content_infor">
                        <ul>
                            <li>
                                <dl>
                                    <dt>Release Date</dt>
                                    <dd class="p-_post_date">2021.11.01</dd>
                                </dl>
                            </li>
                            <li>
                                <dl>
